...
public class BezierCubicTo extends View {
    ...
    public BezierCubicTo(Context context) {
        super(context);
    }

    public BezierCubicTo(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public BezierCubicTo(Context context, AttributeSet attrs, int defStyleAttr) {
