...
public class BezierQuadTo extends View {
    ...
    public BezierQuadTo(Context context) {
        super(context);
    }

    public BezierQuadTo(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public BezierQuadTo(Context context, AttributeSet attrs, int defStyleAttr) {
